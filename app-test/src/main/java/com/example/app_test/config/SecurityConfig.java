package com.example.app_test.config;

import com.example.app_test.security.filter.ApiCheckFilter;
import com.example.app_test.security.filter.ApiLoginFilter;
import com.example.app_test.security.handler.ApiLoginFailHandler;
import com.example.app_test.security.util.JWTUtil;
  ...
  protected SecurityFilterChain config(HttpSecurity httpSecurity) throws Exception {
    ...
    httpSecurity.authorizeHttpRequests(
        auth -> auth
            ...
            .requestMatchers("/uploadAjax").permitAll()
            .requestMatchers("/display/**").permitAll()
            .requestMatchers("/removeFile/**").permitAll()
